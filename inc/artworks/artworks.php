		...
		<div id="artwork_licenses_box" class="loop-box">
			<div class="half-1">
				...
				<ul class="input-container site-license main-input">
					...
					<li><label><input type="checkbox" class="site-license" name="artwork_site_license[]" <?php if ((is_array($site_license)) && in_array('cc_by_nc_nd', $site_license)) echo "checked"; if ('cc_by_nc_nd' == $site_license) echo "checked"; ?> value="cc_by_nc_nd" /><?php _e('CC-BY-NC-DD', 'arteforadomuseu'); ?></label></li>
			...
			<div class="half-2">
				...
				<ul class="input-container resource-languages main-input">
					...
					<li><label><input type="checkbox" class="resource-license" name="artwork_resource_license[]" <?php if ((is_array($resource_license)) && in_array('cc_by_nc_nd', $resource_license)) echo "checked"; if ('cc_by_nc_nd' == $resource_license) echo "checked"; ?> value="cc_by_nc_nd" /><?php _e('CC-BY-NC-DD', 'arteforadomuseu'); ?></label></li>
